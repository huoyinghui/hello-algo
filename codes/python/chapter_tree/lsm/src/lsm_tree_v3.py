...
from storage import StorageBackend, StorageConfig, StorageFactory
...
# 测试和演示代码
def test_lsm_tree_v3():
    """测试LSM-Tree V3功能"""
    print("=== LSM-Tree V3 测试开始 ===")
...
def demo_storage_switching_v3():
    """演示存储后端切换 V3"""
    print("\n=== 存储后端切换演示 V3 ===")
    
    # 从内存存储开始
    lsm = LSMTreeV3(storage_type='memory', max_memtable_size=5)
